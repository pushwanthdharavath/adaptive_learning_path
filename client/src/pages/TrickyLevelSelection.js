...
const TrickyLevelSelection = () => {
  ...
  const handleLevelClick = (level) => {
    ...
    navigate(`/tricky-games/level/${level.id}`);
  };
    ...
    <div className="level-selection-container">
      <div className="level-content">
        <header className="level-header">
          <h1 className="level-title">Tricky Challenge Levels</h1>
...
export default TrickyLevelSelection;
