...
const EnglishLevelSelection = () => {
  ...
  const handleLevelClick = (level) => {
    ...
    navigate(`/english-quiz/level/${level.id}`);
  };
    ...
    <div className="level-selection-container">
      <div className="level-content">
        <header className="level-header">
          <h1 className="level-title">English Challenge Levels</h1>
...
export default EnglishLevelSelection;
